...
# minimal_kedro documentation build
...
from minimal_kedro import __version__ as release

# -- Project information -----------------------------------------------------

project = "minimal_kedro"
author = "Kedro"
...
htmlhelp_basename = "minimal_kedrodoc"
...
texinfo_documents = [
    (
        ...
        author,
        "minimal_kedro",
        "Project minimal_kedro codebase.",
        "Nearest-Neighbour",
    )
]
